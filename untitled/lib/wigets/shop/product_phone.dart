...
class Product_phone extends StatefulWidget {
  const Product_phone({Key? key}) : super(key: key);

  @override
  _ProductListState createState() => _ProductListState();
}

class _ProductListState extends State<Product_phone> {
  ...
  Future<List<Product>> _fetchProducts() async {
    try {
      final response = await http.get(
        Uri.parse('http://10.0.2.2:8000/api/flashsale'),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                width: 124,  // Slightly less than card width for padding
                height: 124, // Square aspect ratio
                child: ClipRRect(
